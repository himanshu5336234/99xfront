            ...
            <div className="office container">
                ...
                <div className="row">
                    <div className="col col-6">
                        <img src="https://ik.imagekit.io/99x/seo/UK_1__lWrMAHWaR.png"/>
                    </div>
                    <div className="col col-6">
                        <img src="https://ik.imagekit.io/99x/seo/Singapore_1__vix-puwKK.png"/>
                    </div>
                    <div className="col col-6">
                        <img src="https://ik.imagekit.io/99x/seo/India_1__bv2GthLcf.png"/>
                    </div>
                    <div className="col col-6">
                        <img src="https://ik.imagekit.io/99x/seo/USA_1__DAaLB-dKy4.png"/>
                    </div>
                </div>
            </div>
