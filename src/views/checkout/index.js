...
import W3StarRating from '../../components/W3StarRating';
    ...
    render(){
        ...
        if(this.state.cart){
            ...
            if(this.state.cart.service.serviceType != "SUBSCRIPTION"){
                ...
                BannerImage = selectedService.icons.d228x202
            }
        ...
        <div className="fluid">
            ...
            {/* {(1==2) ? 
            <div className="content_wrapper page_checkout container">
                ...
                <div className="row">
                    ...
                    <div className="cart-service">
                        ...
                        {(this.state.cart.service && this.state.cart.service.banners.length > 0) ? 
                            <img src={this.state.cart.service.banners[0]}/>
                            :
                            null
                        }
                        ...
                        <h3 className="color-pink">{this.state.cart.service.title}</h3>
                        <div className="w3-service-rating">
                        ...
                        <p>{this.state.cart.service.subtitle}</p>
                        </div>
                    ...
                    <div className="col-md-6 col-sm-12">
                        <div className="card summary-card">
                            ...
                            <table>
                                ...
                                >
                                {this.state.loading?'Please wait...':'Place Order'}
                                </button>
                        </div>
                        <br/>
                        <br/>
