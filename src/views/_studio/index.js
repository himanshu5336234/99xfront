    ...
    render(){
        ...
        <div className="fluid pv-20">
            <section className="container">
                <div className="row">
                    <div className="col-12 col-sm-12 col-md-6 pv-30 home-page">
                        ...
                        Take your business centre stage with <br/>
                            <span style={{color:'#D60A33',fontSize:'3.5rem' }}>stunning videos</span>
                        </h1>
                        ...
                        <div className="fluid d-flex flex-row flex-wrap" style={{marginTop:'48px'}}>
                            <NavLink exact={true} to={'/'} className="custom-button color1">
                                <i class="fa fa-plus" aria-hidden="true"></i> Video ads
                            </NavLink>
                            <NavLink exact={true} to={'/'} className="custom-button color2">
                                <i class="fa fa-plus" aria-hidden="true"></i> Video & Youtube Marketing
                            </NavLink>
                            <NavLink exact={true} to={'/'} className="custom-button color3">
                                <i class="fa fa-plus" aria-hidden="true"></i> Animations & Graphics
                            </NavLink>
                            <NavLink exact={true} to={'/'} className="custom-button color4">
                                <i class="fa fa-plus" aria-hidden="true"></i>Promos
                            </NavLink>
                            <NavLink exact={true} to={'/'} className="custom-button color5">
                                <i class="fa fa-plus" aria-hidden="true"></i> Whiteboard Videos
                            </NavLink>
                            <NavLink exact={true} to={'/'} className="custom-button color6">
                                <i class="fa fa-plus" aria-hidden="true"></i>Product Videos & Explainers
                            </NavLink>
                        </div>
            ...
            <section className="bg-white pv-30">
                <BoostYourStartup
                    site="social"
                    title={<>Boost your marketing  <span>with exceptional videos </span></>}
                    subtitle={<>Spend more time growing your business. We'll help you engage your audience on every level - incredibly effectively, visually  with rad videos and outstanding creators to tell your story.</>}
                />
            </section>
