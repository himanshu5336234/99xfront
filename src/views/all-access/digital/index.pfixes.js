...
export default function DigitalAllAccess(){
    ...
    let [currentPlan1Index, setCurrentPlan1Index] = useState(0);
    let [currentPlan2Index, setCurrentPlan2Index] = useState(0);
    let [currentPlan3Index, setCurrentPlan3Index] = useState(0);
    ...
    const getPlanIndex = (i) => {   
        if(i == 0) return currentPlan1Index
        if(i == 1) return currentPlan2Index
        if(i == 2) return currentPlan3Index
    }
    
    const selectPlanIndex = (value, planIndex) => {
        if(planIndex == 0) setCurrentPlan1Index(value)
        if(planIndex == 1) setCurrentPlan2Index(value)
        if(planIndex == 2) setCurrentPlan3Index(value)
    }
                            ...
                            if(p.title)
                                ...
                                <div className="price-desc-container">
                                    <div className="title-bar">
                                        <h3>{p.title}</h3>
                                        <select 
                                        value={getPlanIndex(i)}
                                        onChange={(e)=>{
                                            // console.log(v);
                                            selectPlanIndex(e.target.value, i)
                                        }}>
                                    ...
                                    <div className="features">
                                        <ul>
                                            ...
                                            {planOptions[i] && planOptions[i][getPlanIndex(i)].features.map((f,i)=>(
                                                <li><span>{f}</span></li>
                                            ))}
                        ...
                        <div className="price-container">
                            <div className="price-left">
                                <div className="price-main">
                                    <sup>$</sup>
                                    <h2>{pricing[currentPlanIndex].price}</h2>
                                </div>
                                <span>/per month</span>
                            </div>
