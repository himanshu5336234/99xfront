...
class OnDemandBrandStyleGuide extends React.Component {
  constructor() {
    super();
    this.state = {
      product: OneTimeProductData.brand_style,
      service: null,
      loading: false,
      activeTab: "basic",
      cart: {
                ...
                <div className="fluid d-flex flex-column align-items-start">
                  ...
                  <div className="fluid">
                    <div className="product-tag-chips">
                      <div className="product-title">Brand Styleguide</div>
...
const ProductRouter = withRouter(OnDemandBrandStyleGuide);
