...
class OnDemandStationary extends React.Component {
  constructor() {
    super();
    this.state = {
      product: OneTimeProductData.stationary,
      service: null,
      loading: false,
      activeTab: "basic",
      cart: {
                ...
                <div className="fluid d-flex flex-column align-items-start">
                  ...
                  <div className="fluid">
                    <div className="product-tag-chips">
                      <div className="product-title">Stationery Kit</div>
...
const ProductRouter = withRouter(OnDemandStationary);
