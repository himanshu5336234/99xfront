...
import ServicePricing from './_components/pricing';
import OneTimeProductData from '../../../data/sites/design/onetime_plans'
...
const CustomerReviews = [
    {
        ...
        review:'They communicate well and get really involved in your pitch with doing research and providing feedback where they see fit. Super helpful and care about the success of your business.',
        review_star:'4.5',
        country:{
    ...
    },
    {
        ...
        review:'Our final project is awesome! They over-delivered and out-performed anything I even expected. If you want to bring your vision to life this is the partner you need on your team!',
        review_star:'5',
        country:{
    ...
    },
    {
        name:'Travis Page',
        profile_image:'https://ik.imagekit.io/99x/startup/_onetime_service/_customer_review/Ellipse_9_QyKg_i-WXm.png',
        review:'After sending them the content and communicating the vibe we were looking for they came back with a stellar deck. The team was super receptive to revisions and turned around ideas quickly. I definitely recommend working with 99x!',
        review_star:'4',
        country:{
            flag_icon: countryImage,
            name:'United States'
...
class OnDemandPitchDeck extends React.Component{
    ...
    componentDidMount(){
        ...
        let product_slug = this.props.match?.params?.slug;
        if(product_slug){
            let productData = OneTimeProductData[product_slug]
            if(productData) this.setState({
                product: productData,
                product_slug
            })
            else{
    ...
    componentWillReceiveProps(newProps){
        //alert("Hello")
        let product_slug = newProps.match?.params?.slug;
        //alert(product_slug)
        if(product_slug){
            let productData = OneTimeProductData[product_slug]
            if(productData) this.setState({
                        ...
                        <div className="container single-service-page">
                            <div className="row">
                                <div className="bread-crumb">
                                    ...
                                    <span>{this.state.product?.category || 'Pitch Deck'}</span>
                                </div>
                            </div>
                            <div className="row">
                                    ...
                                    <div className="fluid d-flex flex-column align-items-start">
                                        ...
                                        <div className="fluid">
                                            <div className="product-tag-chips">
                                                <div className="product-title">
                                                    {this.state.product?.category || 'Pitch Deck'}
                                                </div>
                                                <div className="product-type">On-Demand Service</div>
                                            </div>
                                        ...
                                        <div className="fluid pv-20">
                                            ...
                                            <div className="nav-content">
                                                ...
                                                <p className="text-justify family-Inter" ref={this.ref1} id="description">
                                                            ...
                                                            <>
                                                                <div className="fluid d-flex flex-row">
                                                                    ...
                                                                    <div className="fluid d-flex flex-column">
                                                                        <p className="font-16 margin-none">
                                                                            {review.name}
                                                                            <span className="ph-15">
                                                                                <i className="fa fa-star star-yellow font-12" aria-hidden="true"></i> 
                                                                                {review.review_star}
                                                                            </span>
                                                                        </p>
                                                                        <div className="fluid font-12 d-flex align-items-center color-grey">
                                                                            <img src={review.country.flag_icon} className="country-icon"/>
                                                                            {review.country.name}
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div className="fluid">
                                                                    ...
                                                                    <span className="font-12 review-time color-grey">
                                                                        <i className="icons icon-clock font-12 color-grey"></i> {review.posted_on}
                                                                    </span>
                                                                </div>
                                                                <hr/>
                                                            </>
