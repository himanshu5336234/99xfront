...
const FEATURE_ICONS = {
    ICON_SOCIAL_MEDIA_MANAGER:'',
    ICON_DESIGN_PEN:'https://ik.imagekit.io/99x/design/32px_oEbMzUQG9.png',
    ICON_UX_DESIGNER:'https://ik.imagekit.io/99x/design/Group_66_oOj7Wok_NS.png',
    ICON_UI_DESIGNER:'https://ik.imagekit.io/99x/design/Group_69_w3MDXNmFD.png',
    ICON_UX_ARCHITECT: 'https://ik.imagekit.io/99x/design/Group_71_6810ta5NBnZ.png'
}
                                ...
                                <div className="sub-resources">
                                    ...
                                    <div className="sub-resource">
                                        {MSelectedPlan.resource.map((r,i)=>{
                                            let iconUrl = r.icon.startsWith("ICON") ? FEATURE_ICONS[r.icon]:r.icon
